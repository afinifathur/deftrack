...
class DefectController extends Controller
{
    ...
    public function create()
    {
        ...
        // Siapkan struktur aman untuk @json di Blade (tanpa arrow function di template)
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            foreach ($request->lines as $line) {
                ...
                // Lewati baris jika batch tidak ditemukan
                if (!$batch) {
                    continue;
                }
        ...
        return redirect()
            ->route('defects.index')
            ->with('status', 'Defect disimpan sebagai draft.');
    }
