...
<head>
    ...
    {{-- supaya @push('styles') dari view ikut dimuat --}}
    @stack('styles')
</head>
<body class="bg-body">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="topNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('defects.index') }}">Defects</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('reports.index') }}">Reports</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-light text-primary ms-2 px-3"
                       href="{{ route('settings.index') }}">
                        Settings
                    </a>
                </li>
                {{-- Recycle Bin untuk import sessions --}}
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('imports.recycle') }}">
                         Recycle Bin
                    </a>
                </li>
